...
## Project Structure
- core/ — Shared signal engine, fusion, prediction, database, globe service
- modules/ — One folder per domain (weather, shipping, stocks, etc.)
- rontend/ — React + TypeScript UI
- ackend/ — FastAPI central server
